...
var simulate_data = {
	...
	url: 'https://v3.plant.works/incoming/data/030d7342-a8b2-4a6b-babe-02921919051d',
	params: {

"PRESET_NUMBER": new parameter_classes.Stat(16),
"PRODUCT_NAME": new parameter_classes.Stat(16),
...
//60000
	...
	getConf: function () {
		var data = {
			simulationDuration: 345,600,000,	//milliseconds
